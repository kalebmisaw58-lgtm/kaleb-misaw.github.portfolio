...
const videos = [
  { id: "dQw4w9WgXcQ", title: "SaaS Explainer Video", client: "TechFlow Inc.", category: "Motion Graphics · Explainer", duration: "2:34", description: "Full production explainer for a B2B SaaS platform — scripting, motion graphics, voiceover direction, and color grading.", tags: ["After Effects", "Premiere Pro", "Motion Graphics"] },
