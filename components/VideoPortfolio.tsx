...
const videos = [
  ...
  { id: "S5NqJx5edK0", title: "Togo Independence Day – Cultural Showcase", client: "AFRONOVA", category: "Documentary · Event Coverage", duration: "", description: "A vibrant, fast-paced event recap capturing the energy, military parades, and local traditions of Togo's national celebration.", tags: ["Premiere Pro", "Color Grading", "Event Coverage"] },
  { id: "wLjIRfY12D8", title: "Sierra Leone Independence – Freedom & Heritage", client: "AFRONOVA", category: "Documentary · Cinematic Edit", duration: "", description: "A cinematic documentary-style edit balancing historical gravity with modern celebration, emphasizing rich cultural dance and community stories.", tags: ["Premiere Pro", "Documentary", "Color Grading"] },
